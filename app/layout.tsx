...
export const metadata: Metadata = {
  title: "SHOP.CO",
  description: "SHOPCO makes shopping an unforgettable experience. Buy those things that make your heart happy and have a shopping experience that leaves you wanting more.",
};
