...
const JewelryCategory = () => {
	...
	const [JewelryCategory, setJewelryCategory] = useState<Product[]>([]);

	useEffect(() => {
		const fetchJewelry = async () => {
			const productArr = await fetchProductsByCategory("jewelery", false);
			setJewelryCategory(productArr);
		};
